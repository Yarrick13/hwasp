...
#define HEURISTIC_PUP 4
#define HEURISTIC_COLOURING 5
#define HEURISTIC_BINPACKING 6
#define HEURISTIC_COMBINED 7
#define HEURISTIC_CCP 8
#define HEURISTIC_STABLEMARRIAGE 9
